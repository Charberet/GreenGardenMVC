...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 19 déc. 2023 à 09:28
...
CREATE TABLE IF NOT EXISTS `t_d_client` (
  ...
  `Id_Type_Client` int NOT NULL DEFAULT '1',
...
(16, NULL, 'Test', 'moi', 't@mail.com', '', NULL, 1, 0, 'CLI0000004');
...
(11, '15.00', 'testproduit1', 'produit1', '141414141', 'html/produit', '25.00', 1, 2),
(14, '15.00', 'Test produit 2', 'Produit2', '6655DSDSDSD', 'Photo', '20.00', 3, 4);
...
(23, 2, 'test', '$2y$10$KpdLIfr/ljX80AqCnB0F5eEullMWl.vJmz05fLvzMM/fNs43KdnBm');
...
ALTER TABLE `t_d_lignecommande`
  ADD CONSTRAINT `t_d_lignecommande_ibfk_1` FOREIGN KEY (`Id_Commande`) REFERENCES `t_d_commande` (`Id_Commande`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `t_d_lignecommande_ibfk_2` FOREIGN KEY (`Id_Produit`) REFERENCES `t_d_produit` (`Id_Produit`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `t_d_produit`
--
ALTER TABLE `t_d_produit`
  ADD CONSTRAINT `t_d_produit_ibfk_1` FOREIGN KEY (`Id_Fournisseur`) REFERENCES `t_d_fournisseur` (`Id_Fournisseur`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `t_d_produit_ibfk_2` FOREIGN KEY (`Id_Categorie`) REFERENCES `t_d_categorie` (`Id_Categorie`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
